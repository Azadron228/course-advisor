...
export function TopNav() {
  ...
  return (
    <header className="sticky top-0 z-40 flex items-center justify-between h-16 px-4 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 lg:px-6">
      ...
      <div className="flex items-center gap-2 lg:gap-4">
        ...
        {isAuthenticated && (
          <div className="relative" ref={dropdownRef}>
            ...
            {isProfileOpen && (
              <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-lg py-1 z-50 animate-in fade-in zoom-in duration-200">
                ...
                <div className="p-1">
                  {user?.is_admin && (
                    <button 
                      ...
                      className="flex w-full items-center gap-3 px-3 py-2 text-sm text-indigo-600 dark:text-indigo-400 font-medium rounded-lg hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-colors"
                    >
                      <Shield size={18} />
                      {t('adminPortal')}
                    </button>
