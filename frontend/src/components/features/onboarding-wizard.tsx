...
export function OnboardingWizard() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-xl overflow-hidden transition-all">
        {/* Progress Bar */}
          ...
          {step === 1 && (
            <div className="space-y-6">
              <div className="space-y-2">
                <h2 className="text-2xl font-bold text-gray-900">Welcome to EduPath AI!</h2>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <input
                    {...register('full_name')}
                    className={`block w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none ${
          ...
          {step === 2 && (
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-gray-500">Add tags for skills or topics you want to learn.</p>
              </div>
              ...
              <div className="space-y-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none"
                    placeholder="Type and press Enter (e.g., Python, UI Design)"
                  />
                </div>

                <div className="flex flex-wrap gap-2 min-h-[100px] p-4 bg-gray-50 rounded-xl border border-dashed border-gray-200">
                  {interests.length === 0 ? (
              ...
              <div className="flex gap-4">
                <button
                  onClick={prevStep}
                  className="flex-1 flex items-center justify-center gap-2 border border-gray-200 hover:bg-gray-50 text-gray-600 font-semibold py-3 rounded-xl transition-all"
                >
            ...
            <div className="space-y-6 text-center">
              ...
              <div className="bg-gray-50 p-6 rounded-2xl text-left space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-semibold">{getValues().full_name}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-gray-500">Goal</span>
                  <span className="text-sm font-semibold truncate max-w-[200px]">{getValues().career_goal}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-gray-500">Interests</span>
                  <span className="text-sm font-semibold">{interests.length} topics</span>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <button
                  ...
                  onClick={prevStep}
                  className="flex-1 flex items-center justify-center gap-2 border border-gray-200 hover:bg-gray-50 text-gray-600 font-semibold py-3 rounded-xl transition-all disabled:opacity-50"
                >
                  Back
                </button>
                <button
