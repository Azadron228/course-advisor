...
class AdvisorService:
    def __init__(self, course_repo: CourseRepository, scoring_service: ScoringService):
    ...
    async def recommend(
        ...
        return RecommendationResponse(
            results=results, skill_gap_analysis=analysis_data, learning_path=learning_path
        )
