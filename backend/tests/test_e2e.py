...
class TestEndToEnd(unittest.TestCase):
    ...
    def test_full_pipeline_logic(self):
        ...
        student = Student(
            id="test_student", name="Test User", transcript=entries, current_skills=["Python"]
        )
        pref = UserPreference(
            interest_tags=["AI", "Security"], target_difficulty=0.5, max_workload=0.5
        )
        ...
        self.scorer.rag_scorer.score = AsyncMock(
            return_value=AgentRecommendation(
